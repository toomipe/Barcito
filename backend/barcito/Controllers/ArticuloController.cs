...
public class ArticuloController : ControllerBase
{
  ...
  [HttpGet("{articuloId}")]
  public ActionResult<Categoria> GetArticuloByID(int articuloId)
  {
    ArticuloRepository articuloRepo = new ArticuloRepository();
    var articu = articuloRepo.FindById(articuloId);
    ...
    return NotFound($"No se encontró la categoría con ID {articuloId}.");
  }
